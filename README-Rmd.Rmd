...
Note I'm using `previewing-sequence` to run two commands: the first
converts an .Rmd file to md using knitr, then the next converts an
`.md` file to HTML using pandoc. The command lines are constructed by
